...
!(function (e, t) {
  ...
  function F(r, n) {
    function Pc(e) {
      if (e || 0 === e) {
        i && (ke.history.scrollRestoration = "auto");
  ...
  function O(e) {
    return (
      (we = e || q()) &&
        ...
        document.body &&
        ((ke = window),
        (Ce = (Me = document).documentElement),
        (Ae = Me.body),
        (t = [ke, Me, Ce, Ae]),
        we.utils.clamp,
  ...
  var we,
    ...
    Fe = {
      ...
      sc: F(function (e) {
        return arguments.length
          ? ke.scrollTo(e, Je.sc())
          : ke.pageXOffset || Me[r] || Ce[r] || Ae[r] || 0;
      }),
    },
    Je = {
      s: n,
      ...
      sc: F(function (e) {
        return arguments.length
          ? ke.scrollTo(Fe.sc(), e)
          : ke.pageYOffset || Me[n] || Ce[n] || Ae[n] || 0;
      }),
    };
  (Fe.op = Je), (k.cache = 0);
  var P =
      ...
      ((ScrollTrigger.prototype.init = function init(_, T) {
        if (
          ...
          var k,
            ...
            $,
            o,
            Q = (_ = eb(Ia(_) || Ka(_) || _.nodeType ? { trigger: _ } : _, It))
              .onUpdate,
            Z = _.toggleClass,
            a = _.id,
            ee = _.onToggle,
          ...
          if (
            ...
            ie &&
              (!1 === oe ||
                oe === Mt ||
                (oe = !(!oe && "flex" === cb(ie.parentNode).display) && Pt),
              (Se.pin = ie),
            ...
            (Se.revert = function (e, t) {
              ...
              r !== Se.isReverted &&
                (r &&
                  (Se.scroll.rec ||
                    (!at && !pt) ||
                    ((Se.scroll.rec = Ce()), pt && Ce(0)),
                  (U = Math.max(Ce(), Se.scroll.rec || 0)),
                  (K = Se.progress),
                  (q = T && T.progress())),
                E &&
                ...
                ie &&
                  (r
                    ...
                    : (ue && Se.isActive) || Ub(ie, R, cb(ie), F)),
                (Se.isReverted = r));
            }),
              ...
              if ((!at && Se.enabled) || t)
                if (ie && e && vt) mb(ScrollTrigger, "scrollEnd", Eb);
                  ...
                  for (
                    Ja(y) && (y = y(Se)),
                      C =
                        $b(y, ne, d, ge, Ce(), E, B, Se, p, we, me, g, fe) ||
                        (ie ? -0.001 : 0),
                      Ja(v) && (v = v(Se)),
                      Ia(v) &&
                        !v.indexOf("+=") &&
                  ...
                  if (
                    ...
                    (r = cb(ie)),
                      ...
                      (c = me && J(be, o ? Fe : Je)()),
                      oe &&
                        (((F = [oe + ge.os2, D + b + At]).t = R),
                        (S = oe === Pt ? gb(ie, ge) + D + b : 0) &&
                          F.push(ge.d, S + At),
                        Lt(F),
                        me && Ce(U)),
                      me &&
                  ...
                  f &&
                    ...
                    (Se.end = A),
                    (P = M = Ce()),
                    fe || pt || (P < U && Ce(U), (Se.scroll.rec = 0)),
                    Se.revert(!1, !0),
                    G &&
                      ((Pe = -1), Se.isActive && Ce(C + D * K), G.restart(!0)),
                    (at = 0),
                    T &&
                      he &&
                      (T._initted || q) &&
                    ...
                    (K === Se.progress && !fe) ||
                      ...
                      (Se.progress = (P - C) / D === K ? 0 : K),
                      Se.update(0, 0, 1)),
                    ie && oe && (R._pinOffset = Math.round(Se.progress * j)),
                    te && te(Se);
                }
            }),
              ...
              if (!fe || r || e) {
                ...
                if (
                  (t &&
                    ((M = P),
                    (P = fe ? Ce() : u),
                    ce && ((W = S), (S = T && !he ? T.totalProgress() : d))),
                  se &&
                    !d &&
                    ie &&
                    !at &&
